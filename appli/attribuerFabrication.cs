...
namespace appli
{
    public partial class attribuerFabrication : DevComponents.DotNetBar.Office2007Form
    {
        DataTable table;
        MySqlDataAdapter da = new MySqlDataAdapter();
       
        public attribuerFabrication()
        {
            InitializeComponent();
        ...
        public void numDepannage()
        {
            ...
            MySqlCommand cmd = new MySql.Data.MySqlClient.MySqlCommand(query, c.con);
        ...
        {
            ConnexionDB c = new ConnexionDB();
            string query = "SELECT date_enregistrer, nom_employe  FROM fabrication INNER JOIN employe ON (num_employe=numero_employe) WHERE num_fabrication='" + this.numero.Text + "'";
            MySqlCommand cmd = new MySqlCommand(query, c.con);
            MySqlDataReader reader;
        ...
        {
            ConnexionDB c = new ConnexionDB();
            string query = "SELECT date_enregistrer, nom_employe  FROM fabrication INNER JOIN employe ON (num_employe=numero_employe) WHERE num_fabrication='" + valeur + "'";
            MySqlCommand cmd = new MySqlCommand(query, c.con);
            MySqlDataReader reader;
        ...
        public void chargerTableau()
        {
            ...
            ConnexionDB c = new ConnexionDB();
            string val = "non attribuée";
            string query = "SELECT num_fabrication, date_enregistrer,appareil,quantite_fabrication FROM fabrication where statut_fabrication='"+val+"' ";
            MySqlCommand cmd = new MySqlCommand(query, c.con);
            ...
            this.TListePresta.Columns[2].Width = 300;
