...
namespace appli
{
    public partial class supEnseignant : DevComponents.DotNetBar.Office2007Form
    {
        DataTable table;
        MySqlDataAdapter da;
        ...
        public supEnseignant()
        {
            ...
            this.suppEnseignant.Click += new System.EventHandler(this.suppEnseignant_Executed);
        ...
        public void chargerTableau()
        {
            ...
            this.listeEnseignant.Columns[5].HeaderText = "Email";
